...
export declare function change(rowIndex: number, row: Array<any>, callback: Function): void;
export declare function appendRow(array: Array<any>, callback: Function): void;
