...
import { Chart, BarController, CategoryScale, LinearScale, BarElement, ScatterController, PointElement, LineElement } from "chart.js";
...
let scatter = [];
let el = undefined;
export function make_histogram(data, bucket_size) {
...
export function plot_histogram(bucket_size, title = "", data) {
...
// chart matrix 
export function make_scatter_matrix(elementId) {
...
let two = undefined;
export function twoD(xs, colors, ...ys) {
    if (two) {
        two.destroy();
    }
    let points = [];
