...
export function returnFrame(obj, data, headers, inPlace, callback, meta) {
...
export function map(values, column, callback, inPlace = false) {
    let index;
...
export function head(len, callback) {
    const work = new Worker("./workers/tableworker.js");
    // //.log(this.Pdata.)
...
export function tail(len, callback) {
    const work = new Worker("./workers/tableworker.js");
    // //.log(this.Pdata.)
...
export function slice(start, end, callback) {
...
export function isNull(callback, column = undefined) {
...
// return a new frame 
export function rename(oldval, value, callback) {
...
export function drop(inPlace = false, callback, ...values) {
    let headers = JSON.parse(JSON.stringify(this.Header_));
...
export function dropna(inPlace = false, callback) {
    let headers = JSON.parse(JSON.stringify(this.Header_));
    let data = JSON.parse(JSON.stringify(this.Pdata.data));
...
export function replace(toReplace, value, callback, inPlace) {
    let headers = JSON.parse(JSON.stringify(this.Header_));
    let data = JSON.parse(JSON.stringify(this.Pdata.data));
    data.forEach((arr, i) => {
        arr.forEach((val, j) => {
...
export function apply_along_axis(axis, fn, where, callback, inPlace = false) {
    let headers = JSON.parse(JSON.stringify(this.Header_));
    let data = JSON.parse(JSON.stringify(this.Pdata.data));
    if (axis === 1) {
...
// group By 
export function group_by(column, predicateFn, callback) {
    let headers = JSON.parse(JSON.stringify(this.Header_));
    let data = JSON.parse(JSON.stringify(this.Pdata.data));
...
export function resetIndex(callback) {
...
export function change(rowIndex, row, callback) {
...
export function appendRow(array, callback) {
